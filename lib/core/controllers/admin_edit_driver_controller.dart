...
class AdminEditDriverController extends GetxController {
  AdminEditDriverController({required this.driver});
  ...
  int get driverId => driver['id'] as int;
  ...
  void onInit() {
    ...
    nameController.text = driver['name'] as String? ?? '';
    vehicleTypeController.text = profile['vehicle_type'] as String? ?? '';
    plateNumberController.text = profile['plate_number'] as String? ?? '';
    ...
    phoneController.text = driver['phone'] as String? ?? '';
  ...
  Future<void> submit() async {
    ...
    try {
      ...
      _showMessage(AppStrings.editDriverFailed, success: false);
    } finally {
...
class AdminEditDriverBinding extends Bindings {
  @override
  void dependencies() {
    Get.put(AdminEditDriverController(driver: Get.arguments as Map<String, dynamic>));
  }
}
