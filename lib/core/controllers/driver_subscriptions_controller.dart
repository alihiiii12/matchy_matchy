...
class DriverSubscriptionsController extends GetxController {
  ...
  Future<void> load() async {
    ...
    error.value = null;
    try {
      final res = await ApiClient.instance.getJson('/driver/subscriptions');
      final data = res.data!['data'] as Map<String, dynamic>;
      accountSubscription.value = data['account'] as Map<String, dynamic>?;
    } on DioException catch (e) {
      error.value = apiFriendlyError(e, fallback: AppStrings.loadDriverSubscriptionsFailed);
    } finally {
      loading.value = false;
    }
  }
...
class DriverSubscriptionsBinding extends Bindings {
  @override
  void dependencies() {
    Get.put(DriverSubscriptionsController());
  }
}
