...
import 'package:matchy_matchy/core/controllers/admin_create_seller_controller.dart';
import 'package:matchy_matchy/core/l10n/app_strings.dart';
import 'package:matchy_matchy/core/theme/app_colors.dart';
import 'package:matchy_matchy/core/widgets/gradient_button.dart';

class AdminCreateSellerScreen extends GetView<AdminCreateSellerController> {
  const AdminCreateSellerScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(AppStrings.createSellerAccount)),
      body: Form(
        key: controller.formKey,
        child: ListView(
          padding: const EdgeInsets.all(20),
          children: [
            _FieldLabel(AppStrings.sellerFullName),
            TextFormField(
            ...
            _FieldLabel(AppStrings.sellerBrandName),
            TextFormField(
            ...
            const SizedBox(height: 16),
            _FieldLabel(AppStrings.sellerSubscriptionAmountPaid),
            TextFormField(
              ...
              validator: (v) {
                ...
                if (value == null || value < 0) return AppStrings.sellerSubscriptionAmountPaidRequired;
                return null;
              },
            ),
            ...
            Obx(
              () => GradientButton(
                label: controller.submitting.value ? AppStrings.creatingSeller : AppStrings.createSeller,
