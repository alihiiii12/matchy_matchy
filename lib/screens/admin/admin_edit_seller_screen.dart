...
import 'package:matchy_matchy/core/controllers/admin_edit_seller_controller.dart';
import 'package:matchy_matchy/core/l10n/app_strings.dart';
import 'package:matchy_matchy/core/theme/app_colors.dart';
import 'package:matchy_matchy/core/widgets/gradient_button.dart';

class AdminEditSellerScreen extends GetView<AdminEditSellerController> {
  const AdminEditSellerScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(AppStrings.editSeller)),
      body: Form(
